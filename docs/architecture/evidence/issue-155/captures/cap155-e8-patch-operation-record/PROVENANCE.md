...
| source GET (scaffolding, deleted) | `_TEST_155E7_src_GET_20260903055606` | `3aa3489d-8d65-4eb1-8cb2-616c9c521222` | 1 | deleted at teardown |
| process (scaffolding, deleted) | `_TEST_155E7_proc_PATCH_20260903055606` | `73499fe2-b6d4-4af3-9657-7080c6da9aab` | 1 | deleted at teardown |
...
|---|---|---|---|---|
| run1 | `execution-3663904b-b15c-43da-8970-2098154a02cb-2026.09.03` | COMPLETE | 200 OK | `2026-09-03T05:56:40.158522427Z` |
| run2_identical_replay | `execution-1639ef10-b48c-4611-90a9-fb92b377214c-2026.09.03` | COMPLETE | 200 OK | `2026-09-03T05:56:50.328132959Z` |
...
- clock-skew control: a host-issued GET at `2026-09-03T05:56:33.555810+00:00` was logged at `2026-09-03T05:56:33.566906174Z`, inside the host bracket (`stamp_within_host_bracket=True`, round trip 12 ms)

## Staged readbacks: a positive subject and an untouched control

| subject | R0 before | R1 between | R2 after |
|---|---|---|---|
| target — **positive subject** | `63f99d8d8744` (200) | `bc5d34d8654c` (200) | `bc5d34d8654c` (200) |
| template — body source | `ed3b9efede80` (200) | `ed3b9efede80` (200) | `ed3b9efede80` (200) |
| control — **negative control** | `a7988baac52f` (200) | `a7988baac52f` (200) | `a7988baac52f` (200) |
