...
| Census rows | 231 |
| Ledger rows (§11.2–§11.4 grain) | 128 |
| Component-XML write routes | 21 |
| Frozen served artifacts | 105 |
...
| LG-f16d0493 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _execute_component | 22 | 3575 | #160 | follow the callee's row; this is an edge, not a site |
...
| LG-f1e10478 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _process_component_preflight | 1 | 5552 | #160 | follow the callee's row; this is an edge, not a site |
...
| #160 | follow the callee's row; this is an edge, not a site | 44 |
...
never deleted. That is why the freeze snapshots the **served values** — 105 artifacts collected
