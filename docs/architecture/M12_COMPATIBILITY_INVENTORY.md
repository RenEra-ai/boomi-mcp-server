...
| LG-ab4b2334 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _compile_authoring | 1 | 9936 | #160 | follow the callee's row; this is an edge, not a site |
...
| LG-308b6e78 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _plan_authoring | 1 | 9874 | #160 | follow the callee's row; this is an edge, not a site |
...
| LG-1f766152 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | build_integration_action | 4 | 10231 | #160 | follow the callee's row; this is an edge, not a site |
