...
| LG-9f90fa64 | legacy_semantic_validation | src/boomi_mcp/categories/integration_builder.py | _process_component_preflight | 1 | 6090 | #160 | delete with the legacy semantic shell |
| LG-599ecc0d | legacy_semantic_validation | src/boomi_mcp/categories/integration_builder.py | _process_ir_semantic_error | 1 | 6116 | #160 | delete with the legacy semantic shell |
...
| LG-3cf79d6e | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _apply_plan | 4 | 9244 | #160 | follow the callee's row; this is an edge, not a site |
| LG-3a7213a4 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _authored_process_validation_error | 1 | 5715 | #160 | follow the callee's row; this is an edge, not a site |
| LG-86e93983 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _build_plan | 4 | 6186 | #160 | follow the callee's row; this is an edge, not a site |
| LG-ab4b2334 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _compile_authoring | 1 | 11664 | #160 | follow the callee's row; this is an edge, not a site |
| LG-01c3922d | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _execute_canonical_process | 2 | 8675 | #160 | follow the callee's row; this is an edge, not a site |
...
| LG-308b6e78 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _plan_authoring | 1 | 11602 | #160 | follow the callee's row; this is an edge, not a site |
| LG-f1e10478 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | _process_component_preflight | 2 | 5960 | #160 | follow the callee's row; this is an edge, not a site |
...
| LG-1f766152 | legacy_transitive_call | src/boomi_mcp/categories/integration_builder.py | build_integration_action | 4 | 11991 | #160 | follow the callee's row; this is an edge, not a site |
...
| LG-85b86f7b | registry_lookup | src/boomi_mcp/categories/integration_builder.py | _process_component_preflight | 3 | 5856 | #153 | replace with canonical ProcessIR materialization/apply |
...
| LG-e5f61bc6 | renderer_call | src/boomi_mcp/categories/integration_builder.py | _process_component_preflight | 2 | 5984 | #153 | replace with canonical ProcessIR materialization/apply |
...
| LG-b1b42a81 | unclassified_reference | src/boomi_mcp/categories/integration_builder.py | _apply_plan | 1 | 10636 | #160 | residue: a watched name mentioned in a shape the census does not classify |
| LG-98073b97 | unclassified_reference | src/boomi_mcp/categories/integration_builder.py | _authored_process_validation_error | 4 | 5708 | #160 | residue: a watched name mentioned in a shape the census does not classify |
...
| LG-32fcd45b | unclassified_reference | src/boomi_mcp/categories/integration_builder.py | _build_plan | 5 | 6509 | #160 | residue: a watched name mentioned in a shape the census does not classify |
...
| LG-66c9297f | unclassified_reference | src/boomi_mcp/categories/integration_builder.py | _process_component_preflight | 13 | 5802 | #160 | residue: a watched name mentioned in a shape the census does not classify |
| LG-79c56926 | unclassified_reference | src/boomi_mcp/categories/integration_builder.py | _process_ir_semantic_error | 2 | 6096 | #160 | residue: a watched name mentioned in a shape the census does not classify |
...
| LG-81ba94b9 | unclassified_reference | src/boomi_mcp/categories/integration_builder.py | _scan_top_level_pipeline_secrets | 1 | 5623 | #160 | residue: a watched name mentioned in a shape the census does not classify |
...
| LG-18b251bf | process_kind_consumer | src/boomi_mcp/categories/integration_builder.py | _authored_process_validation_error | 2 | 5709 | #160 | delete with the legacy consumer |
...
| LG-adf3120a | process_kind_consumer | src/boomi_mcp/categories/integration_builder.py | _build_plan | 2 | 6510 | #160 | delete with the legacy consumer |
...
| LG-d2124aa7 | component_xml_write | src/boomi_mcp/categories/integration_builder.py | _execute_canonical_process | 1 | 8731 | #153 | WRT-canonical-process-materialization: unchanged, and it is what the retraction leaves behind: a process root reaches the platform only through a compiled artifact whose plan fingerprint and apply-time mutation attestation are both recorded. |
