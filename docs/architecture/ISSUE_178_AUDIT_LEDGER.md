...
| 2 | `cdx-gate-review.FrQAIh` | `aedca45344ea9215f77deede343f6724fa264a09` -> `ca5d778` | `ISSUES FOUND` — one **CRITICAL** (`L3R2-01`), one Standard (`L3R2-02`), one Low (`L3R2-03`) | `docs/architecture/evidence/issue-178/architect-reviews/cdx-gate-review.FrQAIh/` |
