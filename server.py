...
if manage_account_action:
    ...
    def manage_account(
        ...
        Actions and config examples:
            ...
            list_assignable_roles - List roles that can be assigned to users
            ...
            remove_user_role - Remove role assignment:
                resource_id="assignment-id" OR config='{"user_id": "user-123", "role_id": "role-456"}'
