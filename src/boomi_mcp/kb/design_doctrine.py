...
_ENTRIES: List[Dict[str, Any]] = [
    ...
    },
    {
        ...
        "boomi_shape_mapping": (
            ...
            "today; true parallel chunk fan-out remains design guidance. The XML "
            "split and per-document batching forms are live-captured; the JSON split "
            "form and both combine forms are reconciled from the companion reference "
            "rather than a live capture. A "
    ...
    },
    {
        ...
        "boomi_shape_mapping": (
            ...
            "cardinality changes (one-to-many and many-to-one; the XML split "
            "form is live-captured, while the JSON split form and the combine "
            "operation are reconciled from the companion reference rather than a "
            "live capture) — over custom "
