...
- troubleshooting: Troubleshoot failed executions (error_details, retry, reprocess, queues)
- schedules: Process schedule management (list, get, update, delete)
- shared_resources: Shared web servers and communication channels
- account: Account administration (roles, component branches)
