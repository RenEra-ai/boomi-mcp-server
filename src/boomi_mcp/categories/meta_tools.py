...
_PROCESS_FLOW_PROTOCOLS = {
    "database_to_api_sync": {
        ...
        "notes": [
            ...
            "notify -> dlq route -> catch stop. It requires a wired catch path — a "
            "supported DLQ (document_cache_ref / error_subprocess_ref) OR a "
            "reliability.catch_exception throw terminal (issue #108 M10.4, where "
            "the leg becomes notify -> [dlq route ->] exception). message_template "
