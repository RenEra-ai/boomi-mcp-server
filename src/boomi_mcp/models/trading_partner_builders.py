...
def build_as2_communication_options(**kwargs):
    ...
    if encrypt_alias:
        partner_info['encryptionPublicCertificate'] = {'@type': 'PublicCertificate', 'componentId': encrypt_alias}
    if sign_alias:
        partner_info['signingPublicCertificate'] = {'@type': 'PublicCertificate', 'componentId': sign_alias}
    if mdn_alias:
        partner_info['mdnSignaturePublicCertificate'] = {'@type': 'PublicCertificate', 'componentId': mdn_alias}
